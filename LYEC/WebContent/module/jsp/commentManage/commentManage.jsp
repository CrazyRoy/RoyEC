...
<html>
  ...
  <body>
  	...
  	<div class="input-group" style="float: right;">
  		<button type="button" onclick="openUserRoleModal()" class="btn btn-primary glyphicon glyphicon-zoom-in">&nbsp;查看</button>
  		<button onclick="delCommentData()" type="button" class="btn btn-danger glyphicon glyphicon-trash">&nbsp;删除</button>
  ...
  <script type="text/javascript" src="module/js/commentManage/commentManage.js"></script>
</html>
